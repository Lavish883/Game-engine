...
export class collisonBox {
    ...
    getSweptBroadphaseBox(sprite) {
        ...
        broadphaseBox.width = sprite.vx > 0 ? sprite.vx + sprite.width : sprite.width - sprite.vx;
        broadphaseBox.height = sprite.vy > 0 ? sprite.vy + sprite.height : sprite.height - sprite.vy;
    ...
    checkCollison(sprite, allOtherSprites) {
        ...
        for (var i = 0; i < possibleStaticCollisons.length; i++) {
            ...
            if (this.normalAABB(broadphaseBox, otherSprite.collisonBox)) {
                // it has to be this, passed in sweptAABB as it based on the collisonBox of the sprite
                var collisonInfo = this.sweptAABB(this, otherSprite.collisonBox);
